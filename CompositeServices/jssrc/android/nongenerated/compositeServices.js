    ...
    if (status == 400) {
        if (NewsComposite["opstatus"] == 0) {
            if (NewsComposite != null && NewsComposite != undefined) {
                ...
                frmComposite.segCompoYahoo.setData([{
                    lblCTitle: "" + globalService[kony.decrement(1)][kony.decrement("Title")],
                    lblCDate: "" + globalService[kony.decrement(1)][kony.decrement("PubDate")],
                    imgArrow: ""
                }, {
                    lblCTitle: "" + globalService[kony.decrement(2)][kony.decrement("Title")],
                    lblCDate: "" + globalService[kony.decrement(2)][kony.decrement("PubDate")],
                    imgArrow: ""
                }, {
                    lblCTitle: "" + globalService[kony.decrement(3)][kony.decrement("Title")],
                    lblCDate: "" + globalService[kony.decrement(3)][kony.decrement("PubDate")],
                    imgArrow: ""
                }, {
                    lblCTitle: "",
                    lblCDate: "MORE",
                    imgArrow: "arwrightd.png"
                }]);
                frmComposite.segCompoGoogle.setData([{
                    lblGIntro: "" + globalGoogle[kony.decrement(1)][kony.decrement("Title")],
                    lblPublish: "" + globalGoogle[kony.decrement(1)][kony.decrement("PubDate")],
                    imgNext: ""
                }, {
                    lblGIntro: "" + globalGoogle[kony.decrement(2)][kony.decrement("Title")],
                    lblPublish: "" + globalGoogle[kony.decrement(2)][kony.decrement("PubDate")],
                    imgNext: ""
                }, {
                    lblGIntro: "" + globalGoogle[kony.decrement(3)][kony.decrement("Title")],
                    lblPublish: "" + globalGoogle[kony.decrement(3)][kony.decrement("PubDate")],
                    imgNext: ""
                }, {
                    lblGIntro: "",
                    lblPublish: "MORE",
                    imgNext: "arwrightd.png"
                }]);
            }
        }
        frmComposite.show();
